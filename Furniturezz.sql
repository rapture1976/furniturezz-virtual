...
--
CREATE DATABASE IF NOT EXISTS `Furniturezz` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `Furniturezz`;
...
CREATE TABLE IF NOT EXISTS `furniture_details` (
  ...
  `furniture_make` varchar(50) NOT NULL,
  `furniture_model` varchar(100) NOT NULL,
  `furniture_color` varchar(500) NOT NULL,
